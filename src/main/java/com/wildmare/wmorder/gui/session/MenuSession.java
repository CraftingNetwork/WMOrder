...
public final class MenuSession {
    ...
    private OrderQuery query;private CreateState createState;private Inventory inventory;
    ...
    public OrderQuery query(){return query;}public void query(OrderQuery query){this.query=query;}public CreateState createState(){return createState;}public void createState(CreateState state){this.createState=state;}
    public Inventory inventory(){return inventory;}public void inventory(Inventory inventory){this.inventory=inventory;}
